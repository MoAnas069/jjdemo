/* ═══════════════════════════════════════════════════════════════
   PRISM — Vanilla JS Port (from React Bits)
   OGL WebGL shader-based animated prism effect
   ═══════════════════════════════════════════════════════════════ */

import { Renderer, Triangle, Program, Mesh } from 'ogl';

/**
 * Creates a Prism WebGL effect inside the given container element.
 * @param {HTMLElement} container — The DOM element to render into.
 * @param {Object} opts — Configuration options.
 * @returns {Object} Controller with destroy() method.
 */
export function createPrism(container, opts = {}) {
  const {
    height = 3.5,
    baseWidth = 5.5,
